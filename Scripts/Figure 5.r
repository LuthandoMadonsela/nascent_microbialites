...
#Generating barplot of all OTUs from all samples (panel A)
library(ggplot2)
library(reshape2)
...
barplot
------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
#Generate diversity boxplots faceted by time (panel B)
...
shan_box_plot
------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
#Generate 3D NMDS plot from all OTUs (panel C)
abund = read.csv("NMDS_data_Nubbins.txt", header= TRUE, sep="\t")
...
#Show plot
plot_3D2
htmlwidgets::saveWidget(plot_3D2, "NMDS_3D.html")

#Calculate pairwise ANOSIM scores, grouped by location (Table S5)
...
meta_table = read.csv("CCA_env.txt", row.names=1, header= TRUE, sep="\t")
