...
#Generating barplot of Conserved OTUs October 2019 (panel A)
...
barplot
------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
#Generate 3D NMDS plot from all OTUs in 2019 (panel B)
...
#Calculate pairwise ANOSIM scores, grouped by location (Table S3)
...
------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
#Canonical Correlation Analysis (panel C)
