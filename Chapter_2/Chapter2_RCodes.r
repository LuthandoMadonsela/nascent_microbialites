...
#Read in data
data <- read.csv(file = "Phyla.txt", header=T, sep="\t")
...
#Making a palette with distinctive colours
n <- 11 or 13
...
###Figure 2.5, 2.9 and 2.11
#Generating barplot of Conserved OTUs 
